       ...
       <table width="75%" class="table_form" border="0" cellpadding="4px" align="center">
        ...
        <tr>
          <td colspan="8" align="center" style="padding:8px;">
            ...
            <tr><td colspan="8" style="padding:8px;"></td></tr>
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 10px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>(UV) UltraViolet </h5></td>
            </tr>
            <tr>
