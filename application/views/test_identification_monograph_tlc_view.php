  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
   ...
   <?php 
    ...
    <div id="form_wrapper_lists">
      ...
      <?php echo form_open('test_identification/save_tlc_monograph',array('id'=>'assay_view'));?>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                <textarea rows="15" cols="180" name="tlc_monograph"></textarea>
              </td>
            </tr>
            <tr>
                <td  height="25px" style="padding:4px;background-color:#ffffff;border-top: solid 1px #bfbfbf;text-align: center;" colspan="8" ><input class="btn" type="submit" name="save_tlc_monograph" id="save_tlc_monograph" value="Submit"></td>
            </tr>
       </table>
      </form>
