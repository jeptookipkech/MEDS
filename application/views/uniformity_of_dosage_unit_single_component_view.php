       ...
       <table width="75%" class="table_form" border="0" cellpadding="4px" align="center">
        ...
        <tr>
          <td colspan="8" align="center" style="padding:8px;">
            ...
            <tr><td colspan="8" style="padding:8px;"></td></tr>
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 10px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>Uniformity Of Dosage Unit Single Component</h5></td>
            </tr>
            <tr>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" height="25px" align="left" style="color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><b>Weight of 20 Capsules(g)</b></td>
            </tr>
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table class="inner_table" border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b></b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Capsule + Powder</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Capsule</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Powder</b></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">1.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="peak_area_one" name="estimated_per_content_one"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">2.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_two" name="weight_of_tablet_two" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_two" name="estimated_per_content_two" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_two" name="weight_of_tablet_two" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">3.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_three" name="weight_of_tablet_three" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_three" name="estimated_per_content_three" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_three" name="weight_of_tablet_three" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">4.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_four" name="weight_of_tablet_four" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_four" name="estimated_per_content_four" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_four" name="weight_of_tablet_four" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">5.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_five" name="weight_of_tablet_five" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_five" name="estimated_per_content_five" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_five" name="weight_of_tablet_five" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">6.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_six" name="weight_of_tablet_six" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_six" name="estimated_per_content_six" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_six" name="weight_of_tablet_six" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">7.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_seven" name="weight_of_tablet_seven" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_seven" name="estimated_per_content_seven" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_seven" name="weight_of_tablet_seven" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">8.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_eight" name="weight_of_tablet_eight" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_eight" name="estimated_per_content_eight" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_eight" name="weight_of_tablet_eight" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">9.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_nine" name="weight_of_tablet_nine" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_nine" name="estimated_per_content_nine" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_nine" name="weight_of_tablet_nine" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">10.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_ten" name="weight_of_tablet_ten" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_ten" name="estimated_per_content_ten" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_ten" name="weight_of_tablet_ten" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">11.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="peak_area_one" name="estimated_per_content_one"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">12.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_two" name="weight_of_tablet_two" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_two" name="estimated_per_content_two" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_two" name="weight_of_tablet_two" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">13.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_three" name="weight_of_tablet_three" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_three" name="estimated_per_content_three" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_three" name="weight_of_tablet_three" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">14.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_four" name="weight_of_tablet_four" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_four" name="estimated_per_content_four" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_four" name="weight_of_tablet_four" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">15.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_five" name="weight_of_tablet_five" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_five" name="estimated_per_content_five" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_five" name="weight_of_tablet_five" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">16.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_six" name="weight_of_tablet_six" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_six" name="estimated_per_content_six" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_six" name="weight_of_tablet_six" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">17.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_seven" name="weight_of_tablet_seven" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_seven" name="estimated_per_content_seven" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_seven" name="weight_of_tablet_seven" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">18.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_eight" name="weight_of_tablet_eight" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_eight" name="estimated_per_content_eight" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_eight" name="weight_of_tablet_eight" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">19.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_nine" name="weight_of_tablet_nine" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_nine" name="estimated_per_content_nine" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_nine" name="weight_of_tablet_nine" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">20.</td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_ten" name="weight_of_tablet_ten" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="estimated_per_content_ten" name="estimated_per_content_ten" onChange="calculator_average()"></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="weight_of_tablet_ten" name="weight_of_tablet_ten" onChange="calculator_average()"></input></td>
                    </tr>
                    <tr>
                      ...
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="average_retention_time" name="average_retention_time" onChange="calculator_average()" disabled></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="average_peak_area" name="average_peak_area" onChange="calculator_average()" disabled></input></td>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;"><input type="text" id="average_retention_time" name="average_retention_time" onChange="calculator_average()" disabled></input></td>
                    </tr>
                  </table>
                </td>
            ...
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table class="inner_table" border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Average Weight(a)</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Lowest Weight(b)</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>[(a-b)/a]100</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Comment</b></td>
                    </tr>
                    <tr>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="peak_area_one" name="estimated_per_content_one"></input></td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="peak_area_one" name="estimated_per_content_one"></input></td>
                    </tr>
                  </table>
            ...
            <tr>
              <td colspan="8" height="25px" align="left" style="color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><b>Acceptance Criteria For Mass Uniformity</b></td>
            </tr>
            <tr>
                ...
                <table border="0" class="inner_table" width="80%" align="center">
                  <tr>
                    <td align="center" style="color:#000;padding:8px;color: #0000fb;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    Net Mass Capsule Content</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Deviation %</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">Number Of Capsules</td>
                  </tr>

                  <tr>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">Less than 300mg</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">+/- 10.0</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">Minimum 18</td>
                  </tr>
                  <tr>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;"></td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">+/-20.0</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">Maximum 2</td>
                  </tr>
                  <tr>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">300mg and Over</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">+/-7.5</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">Minimum 18</td>
                  </tr>
                   <tr>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;"></td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">+/-15.0</td>
                    <td style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #000;background-color: #ffffff;">Maximum 2</td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table class="inner_table" border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;border-top:solid 1px #c4c4ff;background-color:#ffffff;border-left:solid 1px #c4c4ff;"></td>
                      <td style="text-align:center;padding:8px;border-top:solid 1px #c4c4ff;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"></td>
                      <td style="text-align:center;padding:8px;border-top:solid 1px #c4c4ff;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"></td>
                      <td colspan="2" style="text-align:center;border-top:solid 1px #c4c4ff;padding:8px;border-left:solid 1px #c4c4ff;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;"><b>Dose & Ratio of Drug Substance</b></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;padding:8px;border-left:solid 1px #c4c4ff;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"><b>Dosage Form</b></td>
                      <td style="text-align:center;border-left:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"><b>Type</b></td>
                      <td style="text-align:center;padding:8px;border-left:solid 1px #c4c4ff;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"><b>Subtype</b></td>
                      <td style="text-align:center;border-left:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"><b>>= 25mg & >= 25% </b></td>
                      <td style="text-align:center;padding:8px;border-left:solid 1px #c4c4ff;border-right:solid 1px #c4c4ff;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"><b> < 25mg or < 25%</b></td>
                    </tr>
                    <tr>
                      <td rowspan="3"  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;border-left:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Capsules</td>
                      <td  style="text-align:center;border-right:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;">Hard</td>
                      <td  style="text-align:center;border-right:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"></td>
                      <td  style="text-align:center;border-right:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;">MV</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">CU</td>
                    </tr>
                    <tr>
                      <td rowspan="2" style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Soft</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Suspensions, emulsions, gel</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">MV</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">CU</td>
                    </tr>
                    <tr>
                      <td   style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Solutions</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">MV</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">MV</td>
            ...
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table class="inner_table" border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Average Weight of Capsule(a)</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Dosage (b) [Label Claim]</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Ratio(b)/(a)</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Method (See Criteria Table Above)</b></td>
                    </tr>
                    <tr>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="peak_area_one" name="estimated_per_content_one"></input></td>
            ...
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table class="inner_table" border="0" width="80%" cellpadding="8px" align="center">
                    ...
                    <tr>
                      <td rowspan="3"  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;border-left:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Tablets</td>
                      <td  style="text-align:center;border-right:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;">Uncoated</td>
                      <td  style="text-align:center;border-right:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;"></td>
                      <td  style="text-align:center;border-right:solid 1px #c4c4ff;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;">WV</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">CU</td>
                    </tr>
                    <tr>
                      <td rowspan="2" style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Coated</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Film</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">WV</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">CU</td>
                    </tr>
                    <tr>
                      <td   style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">Others</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">CU</td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;background-color:#ffffff;border-right:solid 1px #c4c4ff;">CU</td>
            ...
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table class="inner_table" border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Average Weight of Tablets(a)</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Dosage (b) [Label Claim]</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Ratio(b)*100(a)</b></td>
                      <td style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><b>Method</b></td>
                    </tr>
                    <tr>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="retention_time_one" name="weight_of_tablet_one"></input></td>
                      <td  style="text-align:center;padding:8px;border-bottom:solid 1px #c4c4ff;"><input type="text" id="peak_area_one" name="estimated_per_content_one"></input></td>
