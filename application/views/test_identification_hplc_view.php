      ...
      <tr>
        <td colspan ="6">
          ...
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text" name ="peak_area_1" id ="peak_area_1" onchange="calculation_average(); calculation_sd()"></td >
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_1" id="asymmetry_1" onchange="calculation_average(); calculation_sd()"></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_1" id ="resolution_1" onchange="calculation_average(); calculation_sd()"></td>
            <td style="padding: 8px;"><input type = "text" name ="other_1" id ="other_1" onchange="calculation_average(); calculation_sd()"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text" name ="rt_avg" class ="rt" id ="rt_avg"></td>
          ...
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text" name ="rt_sd" class ="rt" id ="rt_sd"></td>
          ...
          <tr>
            ...
            <td style="padding: 8px;"><input type="text" name="rt_ac" class ="rt" id="rt_ac" placeholder ="NMT 2.0%"></td>
            <td style="padding: 8px;"><input type="text" name="peak_area_ac" id="peak_area_ac" placeholder ="NMT 2.0%"onchange="calculation_average(); calculation_sd()"></td>
            <td style="padding: 8px;"><input type="text" name="asymmetry_ac" id="asymmetry_ac" placeholder ="NMT 2.0%"onchange="calculation_average(); calculation_sd()"></td>
            <td style="padding: 8px;"><input type="text" name="resolution_ac" id="resolution_ac" placeholder ="NLT 5.0%"onchange="calculation_average(); calculation_sd()"></td>
            <td style="padding: 8px;"><input type="text" name="other_ac" id="other_ac" placeholder ="NLT"onchange="calculation_average(); calculation_sd()"></td>
