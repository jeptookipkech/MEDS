 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper_lists">
      ...
      <?php echo form_open('assay/save_monograph_hplc_area_method_single_component',array('id'=>'monograph_hplc_area_method_single_component'));?>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
               HPLC AREA METHOD SINGLE COMPONENT DETAILS
              </td>
            </tr>
            <tr>
