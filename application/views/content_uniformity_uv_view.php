       ...
       <table class="table_form" width="75%" border="0" cellpadding="4px" align="center">
        ...
        <input type="hidden" name="assignment_id" value="<?php echo $request[0]['a'];?>"></input>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>Content uniformity By UV</h5></td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                ...
                <a href="<?php echo base_url().'content_uniformity/worksheet_uv/'.$request[0]['a'].'/'.$query['tr'];?>"class="current mid_sub_menu mid_sub_menu_link first_link">By UV</a>
            ...
            <td colspan="8" style="padding:8px;border-bottom:dotted 1px #c4c4ff;">
              <table width="" border="0" align="center" cellpadding="8px"> 
                <tr>
            ...
            <tr>
              <td colspan="8" height="25px" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><b>Weight of Sample Taken</b></td>
            </tr>
            <tr>
              <td colspan="8">
            ...
            <tr>
              <td colspan="8" height="25px" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><b>Sample Preparation</b></td>
            </tr>
            <tr>
              <td colspan="8" height="25px" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><textarea cols="160" rows="6" type="text" name="sample_preparation"></textarea></td>
            </tr>
            <tr>
              <td colspan="8" style="padding:8px;border-bottom:dotted 1px #c4c4ff;">
              <table align="center" width="80%" border="0" cellpadding="8px">
                <tr>
                  <td colspan="0" height="25px" style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;color:#000;">Equipment Make</td>
                  <td colspan="0" height="25px" style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;color:#000;"><input name="equipment_make" type="text" size="40"></input></td>
                  <td colspan="0" height="25px" align="center" style="text-align:center;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;color:#000;">ID Number</td>
                  <td colspan="0" height="25px" align="center" style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;color:#000;"><input name="number" type="text" size="30"></input></td>
                </tr>
              </table>
            ...
            <tr>
              <td colspan="8" height="25px" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;color: #000;background-color: #ffffff;">Absorbance at <input typpe="text" name="absorbance" size="40"></input>nm</td>
            </tr>
            <tr>
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      <td style="padding:4px;border-bottom:solid 1px #c4c4ff;text-align:center;color:#0000ff;padding:8px;">Std 1</td>
                      <td style="padding:4px;border-bottom:solid 1px #c4c4ff;text-align:center;color:#0000ff;padding:8px;">Sample 1</td>
                      <td style="padding:4px;border-bottom:solid 1px #c4c4ff;text-align:center;color:#0000ff;padding:8px;">Sample 2</td>
                      <td style="padding:4px;border-bottom:solid 1px #c4c4ff;text-align:center;color:#0000ff;padding:8px;">Sample 3</td>
                    </tr>
                    <tr>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff;"><input type="" name=""></input></td>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff;"><input type="" name=""></input></td>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff;"><input type="" name=""></input></td>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff;"><input type="" name=""></input></td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff;"><input type="" name=""></input></td>
                      <td style="padding:8px;border-bottom:d0tted 1px #c4c4ff;"><input type="" name=""></input></td>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff;"><input type="" name=""></input></td>
                      <td style="padding:8px;border-bottom:dotted 1px #c4c4ff;"><input type="" name=""></input></td>
                    </tr>
                  </table>
            ...
            <tr>
                <td colspan="8" style="padding:8px;border-bottom:solid 1pf #c4c4ff;">
                  <table border="0" cellpadding="8px" align="center">
                    ...
                    <tr>
                      <td colspan="2" style="color:#0000ff;text-align:center;">A(1%, 1CM)1000 x Weight Taken x Label Claim</td>
                    </tr>
                  </table>
                </td>
            </tr>
