    ...
    <tr>
     ...
     <tr> 
      ...
      <tr>
        ...
        <td colspan = "5"style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['results_assay'];?> </td>  
         </tr>
      <tr>      
        ...
        <td colspan = "5"style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['comment_assay'];?></td>
      </tr>
       <tr>
        <td colspan="6" align="left"  style="padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><b>Conclusion</b></td>
      </tr>
      <tr>
        <td colspan="6" style="padding:8px;border-bottom:solid 1px #c4c4ff;">The test <?php echo $query_e['choice'];?>  </td>
      <tr>
