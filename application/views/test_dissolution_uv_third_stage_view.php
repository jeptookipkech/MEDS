...
<div id="form_wrapper">
<div id="forms">
<?php echo form_open('test_dissolution/worksheet_third_stage', array('id'=>'test_dissolution_view'));?>
    ...
    <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="potency_container" id ="container" value = "<?php echo $sql_dissolution['potency_container']?>" onchange="calculation_weight()"> </td>
      ...
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
          ...
          <input type ="text" name="det_5_lc" id ="det_5_lc" size ="10" placeholder="LC" o onchange="calculation_determinations()"nchange="calculation_determinations()"></td>        
