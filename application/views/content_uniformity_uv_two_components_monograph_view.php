 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper">
      ...
      <?php echo form_open('content_uniformity/save_uv_content_uniformity_two_components_monograph',array('id'=>'content_uniformity_monograph_view'));?>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                Content Uniformity UV Two Components Monograph Details
              </td>
            </tr>
            <tr>
