...
<table width="950px" class ="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['sample_container'];?> </td>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['sample_weight'];?></td>
    </tr>
    <tr>    
        ...
        <td colspan ="5"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['sample_dilution'];?> </textarea></td>
    </tr>
    <tr>      
    ...
    <tr>    
        ...
        <td colspan ="2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['standard_weight_5'];?></td>      
    </tr>    
    ...
    <tr>  
        ...
        <td colspan="5"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['standard_dilution'];?> </td>
    </tr> 
    <tr>      
    ...
    <tr>
        <td colspan="6" align="center" style="padding: 8px;background-color:#ffffff;"><?php echo $query_e['calculation_mobile'];?></td>
    </tr>
    <tr>      
