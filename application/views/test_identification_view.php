...
<table width="950px" class="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
     ...
     <tr> 
      ...
      <tr>  
        <td colspan = "6" style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> The retention time of the major peak in the chromatograph of the Assay preparation </td>
      </tr>
      <tr>
