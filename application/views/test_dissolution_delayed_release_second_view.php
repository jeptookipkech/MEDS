...
<table width="950" class ="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
      ...
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="container" id ="container"onchange="calculation_weight()" value ="<?php echo $sql_dissolution['container'];?>" > </td>
